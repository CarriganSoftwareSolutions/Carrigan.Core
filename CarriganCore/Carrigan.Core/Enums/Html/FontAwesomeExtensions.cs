...
public static class FontAwesomeEnumExtensions
{
    ...
    /// </exception>
    public static string ToHtml(this FontAwesomeEnum icon) => icon switch
    {
        ...
        FontAwesomeEnum.ChartLine => "fa-solid fa-chart-line",
        ...
        FontAwesomeEnum.PeopleGroup => "fa-solid fa-people-group",
        ...
        FontAwesomeEnum.ScaleBalanced => "fa-solid fa-scale-balanced",
        ...
        FontAwesomeEnum.Shield => "fa-solid fa-shield",
        ...
        FontAwesomeEnum.UserCheck => "fa-solid fa-user-check",
