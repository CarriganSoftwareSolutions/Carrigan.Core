...
public class PagedContentBaseTests
{
    ...
    public void PagedContentBase_NavigationPages_Tests(uint pageNumber, uint pageCount, uint[] expected)
    {
        NavigationPagesTestClass testClass = new(pageNumber, pageCount);

        uint[] actual = testClass.NavigationPages;
